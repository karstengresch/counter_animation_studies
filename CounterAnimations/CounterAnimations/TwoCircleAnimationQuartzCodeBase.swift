...
class TwoCircleAnimationQuartzCodeBase
{
  ...
  class func groupAnimations(animations : [CAAnimation], fillMode : String!, forEffectLayer : Bool, sublayersCount : NSInteger) -> CAAnimationGroup!{
    ...
    if forEffectLayer{
      groupAnimation.duration = TwoCircleAnimationQuartzCodeBase.maxDurationOfEffectAnimation(groupAnimation, sublayersCount: sublayersCount)
    }else{
      groupAnimation.duration = TwoCircleAnimationQuartzCodeBase.maxDurationFromAnimations(animations)
    }
